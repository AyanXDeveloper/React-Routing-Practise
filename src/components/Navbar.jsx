...
import profilePhoto from '../assets/Ayan Profile Photo-modified.png'
...
const projectsDropdown = [
  { name: 'Ecommerce Website', href: '/projects/ecommerce-website' },
  { name: 'Todo App', href: '/projects/todo-app' },
]
            ...
            <div className="hidden sm:ml-6 sm:block">
              <div className="flex space-x-4">
                ...
                <Menu as="div" className="relative inline-block text-left">
                  ...
                  <MenuItems
                    transition
                    className="absolute left-0 z-10 mt-2 w-48 origin-top-left rounded-md bg-white shadow-lg outline outline-black/5 transition data-closed:scale-95 data-closed:transform data-closed:opacity-0 data-enter:duration-100 data-enter:ease-out data-leave:duration-75 data-leave:ease-in dark:bg-gray-800 dark:shadow-none dark:-outline-offset-1 dark:outline-white/10"
                  >
